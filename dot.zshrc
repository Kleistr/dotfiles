...
# 获取天气
alias weather='curl -4 http://wttr.in/Jinan'
# 设置terminal 走代理
alias proxy='export all_proxy=socks5://127.0.0.1:1080'
alias unproxy='unset all_proxy'
alias ip="curl cip.cc"
alias daili='echo "使用中的IP:" && curl myip.ipip.net && echo "正在设置代理..." && sleep 1 && export all_proxy=socks5://127.0.0.1:1080 && echo "代理已设置" && curl cip.cc'

# cat 换成 bat
alias cat='bat'

# Path to your oh-my-zsh installation.
export ZSH="/Users/kleist/.oh-my-zsh"
